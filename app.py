...
data = pd.read_csv("injury_prediction.csv",encoding='Latin1')
...
mode_value = data['injury_type_last_occurred'].mode()[0]
data['injury_type_last_occurred'] = data['injury_type_last_occurred'].fillna(mode_value)
...
def class_distribution(data, column_name='injury_next_10_days'):
...
class_distribution(data, 'injury_next_10_days')
...
X = data.drop("injury_next_10_days", axis = 1)

y = data["injury_next_10_days"]
